...
import tannv.updateDetail.UpdateDetailDAO;
import tannv.updateDetail.UpdateDetailDTO;
...
public class UpdateCakeController extends HttpServlet {
    ...
    private final String ADMIN_PAGE = "indexAdmin.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.updateCake(cake);
            if (check) {
                request.setAttribute("listCake",dao.getPageCakeAdmin(1));
                CategoryDAO categoryDAO = new CategoryDAO();
                UpdateDetailDAO updateDetailDAO = new UpdateDetailDAO();
                Date date = new Date();
                updateDetailDAO.createUpdateDetail(new UpdateDetailDTO(userData.getUserID(), cakeID,Convert.utilDateToSqlDate(date) ));
            ...
            LOGGER.error("Update cake is error : "+ e.getMessage());
        }
    }
